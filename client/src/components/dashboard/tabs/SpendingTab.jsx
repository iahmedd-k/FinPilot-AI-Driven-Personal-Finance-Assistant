        ...
        <div style={{ position:"fixed", inset:0, zIndex:300, display:"flex", alignItems:"flex-end", justifyContent:"center", background:"rgba(0,0,0,0.45)", padding: isMobileLocal ? 0 : 16 }}
          ...
          <div style={{
            ...
            <div style={{ padding:"20px 20px 0", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
              <div style={{ fontSize: C.fSizeBase, fontWeight: C.fWeightSemi, color: C.text }}>Add Transaction</div>
              ...
              {addMode==="manual" && (
                <div style={{ display:"flex", flexDirection:"column", gap:13 }}>
                  ...
                  <div style={{ display:"flex", gap:10, flexDirection: isMobileLocal ? "column" : "row" }}>
                    <div style={{ flex:2 }}>
                      <label className="origin-section-label" style={{ fontSize: C.fSizeXs, marginBottom: 5 }}>MERCHANT *</label>
                      <input value={form.merchant} onChange={e=>setForm(f=>({...f,merchant:e.target.value}))}
                        placeholder="e.g. Starbucks" style={inputSx}/>
                    </div>
                    <div style={{ flex:1 }}>
                      <label className="origin-section-label" style={{ fontSize: C.fSizeXs, marginBottom: 5 }}>DATE *</label>
                  ...
                  <div style={{ display:"flex", gap:10 }}>
                    <div style={{ flex:1 }}>
                      <label className="origin-section-label" style={{ fontSize: C.fSizeXs, marginBottom: 5 }}>AMOUNT *</label>
                    ...
                    <div style={{ flex:1 }}>
                      <label className="origin-section-label" style={{ fontSize: C.fSizeXs, marginBottom: 5 }}>TYPE *</label>
                  ...
                  <div>
                    <label className="origin-section-label" style={{ fontSize: C.fSizeXs, marginBottom: 5 }}>CATEGORY</label>
                  ...
                  <div>
                    <label className="origin-section-label" style={{ fontSize: C.fSizeXs, marginBottom: 5 }}>NOTES</label>
        ...
        {subTabs.map(([id, label]) => (
          <button
            ...
            style={{
              ...
              padding: "11px 15px",
              fontSize: C.fSizeXs,
              fontWeight: spendTab === id ? C.fWeightSemi : C.fWeightMed,
              cursor: "pointer",
              whiteSpace: "nowrap"
            }}
          >
    ...
    <div ref={wrapperRef} style={{ position:"relative", width:"100%" }}>
      ...
      {open && popupStyle && createPortal(
        <div
          ...
          style={{ ...popupStyle, padding:"18px 18px 16px", borderRadius:28, border:`1px solid ${C.border}`, boxShadow:"0 24px 64px rgba(0,0,0,0.26)", background:"var(--bg-secondary)", zIndex:10001, boxSizing:"border-box", overflow:"hidden" }}
        >
